        ...
        <div class="accept_info">
                ...
                <form action="update_customer.php" method="POST">
                    ...
                    <div class="Name">
                        ...
                        <input type="text" name="cusName" class="cusName" value="<?= $cusName ?>" placeholder="" >
                    </div>

                    <div class="content1">
                        <div class="Contact">
                            <span>Tên người liên hệ</span>
                            <input type="text" name="cusContact" class="cusContact" value="<?= $cusContact ?>" placeholder="" >
                        </div>
                        <div class="Phone">
                            <span>Số điện thoại</span>
                            <input type="text" name="cusPhone" class="cusPhone" value="<?= $cusPhone ?>" placeholder="" >
                        </div>
                    </div>

                    <div class="Address">
                        <span>Địa chỉ</span>
                        <input type="text" name="cusAddress" class="cusAddress" value="<?= $cusAddress ?>" placeholder="" >
                    </div>

                    <div class="content1">
                        <div class="GPP">
                            <span>Số GPP</span>
                            <input type="text" name="cusGPP" class="cusGPP" value="<?= $cusGPP ?>" placeholder="" >
                        </div>
                        <div class="GPPDate">
                            <span>Ngày cấp</span>
                            <input type="text" name="cusGPPDate" class="cusGPPDate" value="<?= $cusGPPDate ?>" placeholder="" >
                        </div>
                    </div>

                    <div class="GPPAddr">
                        <span>Nơi cấp</span>
                        <input type="text" name="cusGPPAddr" class="cusGPPAddr" value="<?= $cusGPPAddr ?>" placeholder="" >
                    </div>

                    <div class="btn">
                        <a href="Customer.php" class="btn-cancel">Hủy</a>
                        <button type="submit" name="approve" class="btn-edit">Chỉnh sửa</button>
                    </div>
                </form>
        </div>
