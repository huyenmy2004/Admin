        ...
        <form class="w-[87%]" method="POST" action="action-create.php">
            ...
            <div class="flex flex-col px-[40px] py-[20px] text-[#505050]">
                ...
                <div class="flex items-center text-[14px]">
                    ...
                    <span class="text-[#0071AF] px-1 font-[600]">Chi tiết khách hàng</span>
                </div>
                <!-- Title -->
                <div class="flex justify-between items-center py-[25px]">
                    <span class="text-[#0071AF] font-[600]">CHI TIẾT KHÁCH HÀNG</span>
                    <button type="button" onclick="window.location.href='http://localhost/PharmaDI-Admin/customer/customer-edit.php?cusId=<?= $cus['cusId'] ?>'"
                ...
                <div class="flex justify-between mt-1">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="cusStatus" value="<?= $cus['cusStatus'] == 0 ? "Chờ duyệt" : ($cus['cusStatus'] == 1 ? "Đã duyệt" :"Không duyệt") ?>"
                ...
                <div class="relative flex justify-between mt-5 w-full">
                    ...
                    <input type="text" name = "cusName" value="<?= $cus['cusName']?>" readonly
                ...
                <div class="flex justify-between mt-5">
                    <div class="relative">
                        ...
                        <input readonly value="<?= $cus['cusContact']?>" type="text" name="cusContact" class="px-2.5 pl-[20px] py-[8px] w-[600px] border border-solid border-[#d8d8d8] rounded-[6px]  outline-0 text-[13px]">
                    </div>
                    <div class="relative">
                        <span class="text-[13px] absolute px-[5px] bg-white -top-[10px] left-[15px]">Số điện thoại</span>
                        <input type="text" value="<?= $cus['cusPhone']?>" name="cusSellNumber"
                            class="px-2.5 pl-[20px] py-[8px] w-[600px] border border-solid border-[#d8d8d8] rounded-[6px] outline-0 text-[13px]"
                            readonly>
                    </div>
                </div>
                ...
                <div class="flex justify-between mt-5">
                    <div class="relative">
                        ...
                        <input readonly type="text" value="<?= $cus['cusGPP']?>" name="cusId" class="px-2.5 pl-[20px] py-[8px] w-[400px] border border-solid border-[#d8d8d8] rounded-[6px] outline-0 text-[13px]">
                    </div>
                    <div class="relative">
                        <span class="text-[13px] absolute px-[5px] bg-white -top-[10px] left-[15px]">Ngày cấp</span>
                        <input type="text" name="cusStatus" value="<?= $cus['cusGPPDate']?>"
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="cusStatus" value="<?= $cus['cusGPPAddr']?>"
                            class="px-2.5 pl-[20px] py-[8px] w-[400px] border border-solid border-[#d8d8d8] rounded-[6px] outline-0 text-[13px]"
                            value="Chờ duyệt" readonly>
                        </svg>
                    </div>
