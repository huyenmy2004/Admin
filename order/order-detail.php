        ...
        <div class="bg-white m-8 box w-full text-[#505050]">
            <div class="flex justify-between w-full px-[50px] py-3 flex-col text-[#505050]">
                <div class="bg-white flex flex-col py-8 rounded-[10px] w-full max-h-max">
                    ...
                    <span class="text-[#0091D0] font-[600] pt-[25px]">CHI TIẾT ĐƠN HÀNG</span>
                    <div class="flex w-full">
                        <div class="flex flex-col w-full mr-3">
                            ...
                            <input type="text" value="<?= $order->detail($_GET['orderId'])[0]['cusName'] ?>" readonly
                                width="350px"
                                class="mr-14 px-2.5 pl-[10px] py-[6px] w-full border border-solid border-[#d8d8d8] rounded-[6px] outline-0 text-[14px]">
                        </div>
                        <div class="flex flex-col w-full ">
                            ...
                            <input type="text" value="<?= $order->detail($_GET['orderId'])[0]['cusContact'] ?>" readonly
                                width="350px"
                                class="px-2.5 pl-[10px] py-[6px] w-full border border-solid border-[#d8d8d8] rounded-[6px] outline-0 text-[14px]">
                        </div>
                    </div>
                    <div class="flex w-full">
                        <div class="flex flex-col w-full mr-3">
                    ...
                    <div>
                        ...
                        <input type="text" value="<?= $order->detail($_GET['orderId'])[0]['orderNote'] ?>" readonly
                            class="flex border border-solid rounded-[6px] border-[#d8d8d8] px-2.5 w-full h-[50px] text-[14px]">
                    </div>
                    <div
                        ...
                        <?php foreach ($order->brandInOrder($_GET['orderId']) as $brand): ?>
                            ...
                            <?php foreach ($order->detail($_GET['orderId']) as $v):
                                ...
                                <div
                                    ...
                                    <span class="col-span-3 pt-2">  <?= $v['prodNumber'] ?></span>
                    ...
                    <div
                        ...
                        <div class="flex justify-between pb-1">
                            <span>Số lượng</span>
                            <span><?= $order->detail($_GET['orderId'])[0]['num'] ?> (sản phẩm)</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="font-[600]"> Thành tiền </span>
                            <span class="font-[600] text-[#0071AF]"> <?= number_format($order->detail($_GET['orderId'])[0]['total']) ?> VND </span>
                        </div>
                    </div>
                </div>
            </div>
