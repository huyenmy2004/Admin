...
<body>
    <div class="bg-[#505050] bg-opacity-[40%] h-[100vh] w-[100vw] text-[#505050] fixed z-10 flex flex-col justify-center items-center hidden"
        id="popupDlt">
    ...
    <form method="post" action="action-edit.php?newsId=<?=$_GET['newsId']?>" id='form-news-search' class="flex justify-between">
            ...
            <div class="flex justify-between w-full mt-5 px-[50px] py-[25px] flex-col text-[#505050]">
                ...
                <div class="flex justify-between items-center py-[25px]">
                    ...
                    <button type="button"
                        ...
                        onclick="document.getElementById('popupDlt').classList.toggle('hidden')">Xoá quảng cáo</button>
                ...
                <div class="flex flex-col mt-3">
                    ...
                    <input name="newsImgTitle" id="newsImgTitle" value="<?= $newsArray['newsImgTitle']?>" class="hidden">
                    <button type="button"
