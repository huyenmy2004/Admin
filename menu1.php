...
<div class="min-h-[715px] bg-[#0071AF]">
    ...
    <div onclick="window.location.href='http://localhost/PharmaDI-Admin/product/product-list.php'"
        ...
        <span
            class="text-[14px] <?= strpos($url, '/PharmaDI-Admin/product') ? 'text-blue-700' : 'text-white' ?> py-[10px] z-10">Sản
            phẩm</span>
        <div
    ...
    <div onclick="window.location.href='http://localhost/PharmaDI-Admin/customer/customer-list.php'"
        class="relative flex justify-center w-full cursor-pointer z-10 mt-[20px]">
        <span
            class="text-[14px] <?= strpos($url, '/PharmaDI-Admin/customer') ? 'text-blue-700' : 'text-white' ?> py-[10px] z-10">Khách
            hàng</span>
        <div
    ...
    <div onclick="window.location.href='http://localhost/PharmaDI-Admin/order/ad_order.php'"
        class="relative flex justify-center w-full cursor-pointer z-10 mt-[20px]">
        <span
            class="text-[14px] <?= strpos($url, '/PharmaDI-Admin/order') ? 'text-blue-700' : 'text-white' ?> py-[10px] z-10">Đơn
            hàng</span>
        <div
    ...
    <div onclick="window.location.href='http://localhost/PharmaDI-Admin/brand/brand-addmin.php'"
        class="relative flex justify-center w-full cursor-pointer z-10 mt-[20px]">
        <span
            class="text-[14px] <?= strpos($url, '/PharmaDI-Admin/brand') ? 'text-blue-700' : 'text-white' ?> py-[10px] z-10">Thương
            hiệu</span>
        <div
    ...
    <div onclick="window.location.href='http://localhost/PharmaDI-Admin/account/account-list.php'"
        class="relative flex justify-center w-full cursor-pointer z-10 mt-[20px]">
        <span
            class="text-[14px] <?= strpos($url, '/PharmaDI-Admin/account') ? 'text-blue-700' : 'text-white' ?> py-[10px] z-10">Tài
            khoản</span>
        <div
    ...
    <div onclick="window.location.href='http://localhost/PharmaDI-Admin/news/news-list.php'"
        class="relative flex justify-center w-full cursor-pointer z-10 mt-[20px]">
        <span
            class="text-[14px] <?= strpos($url, '/PharmaDI-Admin/news') ? 'text-blue-700' : 'text-white' ?> py-[10px] z-10">Tin
            tức</span>
        <div
